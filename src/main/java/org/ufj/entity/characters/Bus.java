...
public class Bus extends Character {
    long id = 1;
    int carWidth = 32;

    // Constructor need the super arguments
    public Bus(TileManager tm, GamePanel gp, Point2D position, double angle) {
    ...
    public void getImagePlayer() {
        ...
        try {
            ...
            Logger.getLogger(Bus.class.getName()).log(Level.SEVERE, null, e);
        }
    }
}
