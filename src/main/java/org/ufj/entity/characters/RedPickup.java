...
public class RedPickup extends Character {
    long id = 1;
    int carWidth = 32;

    // Constructor need the super arguments
    public RedPickup(TileManager tm, GamePanel gp, Point2D position, double angle) {
    ...
    public void getImagePlayer() {
        ...
        try {
            ...
            Logger.getLogger(RedPickup.class.getName()).log(Level.SEVERE, null, e);
        }
    }
}
